...
class VersionTests {
  ...
  void removeQualifier_when_no_qualifier() {
    ...
    assertThat(version.getPatch()).isEqualTo(3);
    assertThat(version.getQualifier()).isEmpty();
    assertThat(version.getName()).isEqualTo("1.2.3");
  }
  ...
  @Test
  void compareToIgnoreQualifier_should_return_zero_when_equal() {
    var version1 = Version.create("1.2.3-SNAPSHOT");
    var version2 = Version.create("1.2.3-RC1");

    assertThat(version1.compareToIgnoreQualifier(version2)).isZero();
  }

  @Test
  void compareToIgnoreQualifier_should_return_positive_when_greater() {
    var version1 = Version.create("1.3.0-SNAPSHOT");
    var version2 = Version.create("1.2.3-SNAPSHOT");

    assertThat(version1.compareToIgnoreQualifier(version2)).isPositive();
  }

  @Test
  void compareToIgnoreQualifier_should_return_negative_when_lower() {
    var version1 = Version.create("1.2.2-SNAPSHOT");
    var version2 = Version.create("1.2.3-SNAPSHOT");

    assertThat(version1.compareToIgnoreQualifier(version2)).isNegative();
  }
  ...
  @Test
  void hashCode_should_differ_for_different_qualifiers() {
    var version1 = Version.create("1.2.3-SNAPSHOT");
    var version2 = Version.create("1.2.3-RC1");
